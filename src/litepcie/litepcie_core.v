//------------------------------------------------------------
// Generated by Migen & LiteX / -------- / 2019-07-17 16:35:10
//------------------------------------------------------------
...
reg [15:0] pcie_dma_writer_table_loop_index = 16'd1;
...
reg [15:0] pcie_dma_reader_table_loop_index = 16'd1;
...
reg [15:0] pcie_dma_reader_sent_pck_cnt = 16'd1;
reg [31:0] pcie_dma_reader_sent_cnt = 32'd0;
reg [15:0] pcie_dma_reader_packet_nr_storage_full = 16'd0;
wire [15:0] pcie_dma_reader_packet_nr_storage;
reg pcie_dma_reader_packet_nr_re = 1'd0;
reg [15:0] pcie_dma_reader_numofbytes_storage_full = 16'd0;
wire [15:0] pcie_dma_reader_numofbytes_storage;
reg pcie_dma_reader_numofbytes_re = 1'd0;
reg pcie_dma_reader_numofbytes_we = 1'd0;
reg [15:0] pcie_dma_reader_numofbytes_dat_w = 16'd0;
reg pcie_dma_reader_fifo_valid = 1'd0;
reg [63:0] pcie_dma_reader_delay_data = 64'd0;
...
wire pcie_dma_next_source_source_valid;
wire pcie_dma_next_source_source_ready;
wire pcie_dma_next_source_source_last;
wire [63:0] pcie_dma_next_source_source_payload_data;
...
assign dma_writer0_valid = pcie_dma_next_source_source_valid;
assign pcie_dma_next_source_source_ready = dma_writer0_ready;
assign dma_writer0_last = pcie_dma_next_source_source_last;
assign dma_writer0_data = pcie_dma_next_source_source_payload_data;
...
assign pcie_dma_litepciemasterinternalport0_sink_last = ((~pcie_dma_writer_enable_storage) | (pcie_dma_writer_counter == (pcie_dma_writer_bufferizeendpoints_source_payload_length[23:3] - 1'd1)));
...
assign pcie_dma_reader_source_source_valid = pcie_dma_reader_fifo_valid;
...
assign pcie_dma_reader_source_source_payload_data = pcie_dma_reader_delay_data;
...
assign pcie_dma_next_source_source_valid = (pcie_dma_tx_fifo_source_valid & pcie_dma_next_source_source_ready);
assign pcie_dma_next_source_source_payload_data = pcie_dma_tx_fifo_source_payload_data;
assign pcie_dma_next_source_source_last = pcie_dma_tx_fifo_source_last;
assign pcie_dma_tx_fifo_source_ready = pcie_dma_next_source_source_ready;
...
assign litepciecore_csrbank2_loopback_enable0_re = ((litepciecore_csrbank2_sel & litepciecore_interface2_bank_bus_we) & (litepciecore_interface2_bank_bus_adr[4:0] == 5'd20));
...
assign pcie_dma_reader_packet_nr_storage = pcie_dma_reader_packet_nr_storage_full[15:0];
assign litepciecore_csrbank2_reader_packet_nr0_w = pcie_dma_reader_packet_nr_storage_full[15:0];
assign pcie_dma_reader_numofbytes_storage = pcie_dma_reader_numofbytes_storage_full[15:0];
assign litepciecore_csrbank2_reader_numofbytes0_w = pcie_dma_reader_numofbytes_storage_full[15:0];
...
always @(posedge sys_clk) begin
	...
	if ((pcie_dma_reader_fifo_source_valid & pcie_dma_reader_fifo_source_ready)) begin
		pcie_dma_reader_sent_cnt <= (pcie_dma_reader_sent_cnt + 4'd8);
		if (((pcie_dma_reader_sent_cnt + 4'd8) == pcie_dma_reader_table_value_storage[63:32])) begin
			pcie_dma_reader_sent_pck_cnt <= (pcie_dma_reader_sent_pck_cnt + 1'd1);
			pcie_dma_reader_sent_cnt <= 1'd0;
		end
	end
	if ((~pcie_dma_reader_enable_storage)) begin
		pcie_dma_reader_sent_cnt <= 1'd0;
		pcie_dma_reader_sent_pck_cnt <= 1'd1;
	end
	pcie_dma_reader_numofbytes_we <= 1'd0;
	if ((((pcie_dma_reader_packet_nr_storage == pcie_dma_reader_sent_pck_cnt) & pcie_dma_reader_fifo_source_valid) & (pcie_dma_reader_numofbytes_storage != 1'd0))) begin
		if ((pcie_dma_reader_numofbytes_storage > pcie_dma_reader_sent_cnt)) begin
			pcie_dma_reader_fifo_valid <= pcie_dma_reader_fifo_source_valid;
		end else begin
			pcie_dma_reader_fifo_valid <= 1'd0;
		end
		if (((pcie_dma_reader_sent_cnt + 4'd8) == pcie_dma_reader_table_value_storage[63:32])) begin
			pcie_dma_reader_numofbytes_dat_w <= 1'd0;
			pcie_dma_reader_numofbytes_we <= 1'd1;
		end
	end else begin
		pcie_dma_reader_fifo_valid <= pcie_dma_reader_fifo_source_valid;
	end
	if ((pcie_dma_reader_fifo_source_valid & pcie_dma_reader_fifo_source_ready)) begin
		pcie_dma_reader_delay_data <= pcie_dma_reader_fifo_source_payload_data;
	end
	...
	if (litepciecore_csrbank2_reader_packet_nr0_re) begin
		pcie_dma_reader_packet_nr_storage_full[15:0] <= litepciecore_csrbank2_reader_packet_nr0_r;
	end
	pcie_dma_reader_packet_nr_re <= litepciecore_csrbank2_reader_packet_nr0_re;
	if (pcie_dma_reader_numofbytes_we) begin
		pcie_dma_reader_numofbytes_storage_full <= (pcie_dma_reader_numofbytes_dat_w <<< 1'd0);
	end
	if (litepciecore_csrbank2_reader_numofbytes0_re) begin
		pcie_dma_reader_numofbytes_storage_full[15:0] <= litepciecore_csrbank2_reader_numofbytes0_r;
	end
	pcie_dma_reader_numofbytes_re <= litepciecore_csrbank2_reader_numofbytes0_re;
	...
	if (sys_rst) begin
		...
		pcie_dma_writer_table_syncfifo_produce <= 8'd0;
		pcie_dma_writer_table_syncfifo_consume <= 8'd0;
		pcie_dma_writer_table_loop_index <= 16'd1;
		pcie_dma_writer_splitter_offset <= 32'd0;
		pcie_dma_writer_splitter_user_id <= 32'd0;
		pcie_dma_writer_splitter_length <= 24'd0;
		pcie_dma_writer_bufferizeendpoints_source_payload_address <= 32'd0;
		...
		pcie_dma_reader_table_syncfifo_produce <= 8'd0;
		pcie_dma_reader_table_syncfifo_consume <= 8'd0;
		pcie_dma_reader_table_loop_index <= 16'd1;
		pcie_dma_reader_splitter_offset <= 32'd0;
		pcie_dma_reader_splitter_user_id <= 32'd0;
		pcie_dma_reader_splitter_length <= 24'd0;
		pcie_dma_reader_bufferizeendpoints_source_payload_address <= 32'd0;
		...
		pcie_dma_reader_fifo_produce <= 9'd0;
		pcie_dma_reader_fifo_consume <= 9'd0;
		pcie_dma_reader_sent_pck_cnt <= 16'd1;
		pcie_dma_reader_sent_cnt <= 32'd0;
		pcie_dma_reader_packet_nr_storage_full <= 16'd0;
		pcie_dma_reader_packet_nr_re <= 1'd0;
		pcie_dma_reader_numofbytes_storage_full <= 16'd0;
		pcie_dma_reader_numofbytes_re <= 1'd0;
		pcie_dma_reader_numofbytes_we <= 1'd0;
		pcie_dma_reader_numofbytes_dat_w <= 16'd0;
		pcie_dma_reader_fifo_valid <= 1'd0;
		pcie_dma_reader_delay_data <= 64'd0;
